...
import 'package:event_app/features/editProfile/bloc/editprofile_bloc.dart';
      ...
      child: Column(
        children: [
          ...
          CommonTextField(
            ...
            onTap: () async {
              final selectedCity = await AutoRouter.of(context).push<City>(
                CityRoute(selectedCityTitle: state.city.value),
              );
